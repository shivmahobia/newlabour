  ...
  return (
    <div className="px-5 sm:px-10 md:px-20">
      ...
      <div className="relative rounded-md shadow-md bg-white py-6">
        <div className="font-semibold text-center text-[24px] text-[#00487C]">Complaint Status</div>
        ...
        <div className="flex flex-col justify-center items-center gap-4 mt-6 px-4">
          <div className="w-full max-w-xs">
            <div className="mb-1">
              <label className="text-black text-[14px] font-bold">Complaint Number</label>
            </div>
            <input
              type="text"
              placeholder="Enter Number Here"
              className="w-full h-[42px] text-[14px] sm:text-[16px] rounded-md border border-gray-300 px-3 focus:outline-none focus:border-[#00487c] font-normal"
              maxLength={10}
            />
          </div>
